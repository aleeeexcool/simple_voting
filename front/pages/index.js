...
import votingAddress from '../contracts/Voting-contract-address.json'
...
export default class extends Component {
  ...
  _connectWallet = async () => {
    ...
    window.ethereum.on('accountsChanged', ([newAdress]) => {
      if(newAdress === undefined) {
        return this._resetState()
      }
      this._initialize(newAdress)
    })
  ...
  _checkNetwork() {
    ...
    this.setState({
      networkError: 'Please connect Hardhat localhost:8545'
    })
    return false
  }
